...
var _stylishJs = require("./stylish.js");
const box = document.querySelector('.Practice');
console.log(box);
box.addEventListener('click', function() {
    (0, _stylishJs.cycleStyle)(this);
});
function close1() {
    var x = 10;
    function inner() {
...
},{"./stylish.js":"5BxKk"}],"5BxKk":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "randomStyle", ()=>randomStyle);
parcelHelpers.export(exports, "textcolor", ()=>textcolor);
parcelHelpers.export(exports, "cycleStyle", ()=>cycleStyle);
function randomStyle(alpha = 0.4) {
...
function cycleStyle(element) {
    ...
    if (textcolor === black || textcolor === undefined) textcolor = white;
    else if (textcolor === white) textcolor = black;
...
//# sourceMappingURL=Practice.e02fbd41.js.map
